...
const handleSubmit = async (event) => {
    ...
    try {
      const response = await axiosCookie.post(`http://localhost:8080/Monolithic_REST-1.0-SNAPSHOT/api/shipping-resource/login/${username}/${password}`);
